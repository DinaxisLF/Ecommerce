    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/catalogo">Catalogo
          ...
          <li class="nav-item">
            <a class="nav-link" href="/acerca">Acerca De
    ...
    <div class="container text-center text-md-start">
      <div class="row text-center text-md-start">
        ...
        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
          ...
          <hr class="mb-4">
          <p>
            En Construmex nuestra objetivo es brindarte todo lo necesario para que construyas
            aquello que tanto sueñas y hacerlo realidad, brindando la mejor calidad de materiales
            de construcción con la mejor atencion de todo el mercado. <br> <br> <strong>!Construye con nosotros¡ </strong>
          </p>
        </div>

        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3 text-center">
          <h5 class="text-uppercase mb-4 font-weight-bold text-primary"> Construye Tus Sueños </h5>
          <hr class="mb-4">
          <p>
            <a href="#" class="text-light"> Catalogo </a>
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3 text-center">
          ...
          <hr class="mb-4">
          <p>
            <li class="fas fa-home me-3"></li>Guadalajara, Jalisco
            <li class="fas fa-envelope me-3"></li>construmx@gmail.com
            <li class="fas fa-phone me-3"></li>+52 3398614520
          </p>
